...
class add_project(unittest.TestCase):
    ...
    def test_addprotect(self):
        ...
        self.driver.find_element(*projectpagelocator.projectbutton).click()
        self.driver.find_element(*projectpagelocator.projectname).send_keys(projectname)
        self.driver.find_element(*projectpagelocator.addproject).click()
    ...
    def tearDown(self):
        ...
        self.driver.find_element(*projectpagelocator.search).send_keys(projectname)
        self.driver.find_element(*projectpagelocator.application).click()
        self.driver.find_element(*projectpagelocator.delete).click()
        self.driver.find_element(*projectpagelocator.confirm).click()
        self.driver.find_element(*projectpagelocator.deletebutton).click()
        self.driver.quit()
